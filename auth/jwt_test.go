...
import (
	...
	"github.com/hinagithub/go_todo_app.git/testutil/fixture"
...
func TestJWTTer_GetToken(t *testing.T) {
	t.Parallel()

	c := clock.FixedClocker{}
	want, err := jwt.NewBuilder().
		Issuer(`github.com/hinagithub/go_todo_app`).
	...
	if !reflect.DeepEqual(got, want) {
		t.Errorf("GetToken() got = %v, want %w", got, want)
	}
}
